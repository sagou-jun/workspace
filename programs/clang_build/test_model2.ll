...
%struct.ExtU_test_model2_T = type { double, double, double, double }
%struct.ExtY_test_model2_T = type { double, double, double }
...
@test_model2_Y = common global %struct.ExtY_test_model2_T zeroinitializer, align 8
...
entry:
  %rtb_Divide = alloca double, align 8
  ...
  %add = fadd double %0, %1
  store double %add, double* getelementptr inbounds (%struct.ExtY_test_model2_T* @test_model2_Y, i32 0, i32 0), align 8
  %2 = load double* getelementptr inbounds (%struct.ExtU_test_model2_T* @test_model2_U, i32 0, i32 0), align 8
  %3 = load double* getelementptr inbounds (%struct.ExtU_test_model2_T* @test_model2_U, i32 0, i32 2), align 8
  %div = fdiv double %2, %3
  store double %div, double* %rtb_Divide, align 8
  %4 = load double* %rtb_Divide, align 8
  store double %4, double* getelementptr inbounds (%struct.ExtY_test_model2_T* @test_model2_Y, i32 0, i32 1), align 8
  %5 = load double* %rtb_Divide, align 8
  %6 = load double* getelementptr inbounds (%struct.ExtU_test_model2_T* @test_model2_U, i32 0, i32 3), align 8
  %sub = fsub double %5, %6
  store double %sub, double* getelementptr inbounds (%struct.ExtY_test_model2_T* @test_model2_Y, i32 0, i32 2), align 8
  ret void
}
...
entry:
  %0 = load %struct.tag_RTM_test_model2_T** @test_model2_M, align 8
  %errorStatus = getelementptr inbounds %struct.tag_RTM_test_model2_T* %0, i32 0, i32 0
  store volatile i8* null, i8** %errorStatus, align 8
  store double 0.000000e+00, double* getelementptr inbounds (%struct.ExtU_test_model2_T* @test_model2_U, i32 0, i32 0), align 8
  store double 0.000000e+00, double* getelementptr inbounds (%struct.ExtU_test_model2_T* @test_model2_U, i32 0, i32 1), align 8
  store double 0.000000e+00, double* getelementptr inbounds (%struct.ExtU_test_model2_T* @test_model2_U, i32 0, i32 2), align 8
  store double 0.000000e+00, double* getelementptr inbounds (%struct.ExtU_test_model2_T* @test_model2_U, i32 0, i32 3), align 8
  store double 0.000000e+00, double* getelementptr inbounds (%struct.ExtY_test_model2_T* @test_model2_Y, i32 0, i32 0), align 8
  store double 0.000000e+00, double* getelementptr inbounds (%struct.ExtY_test_model2_T* @test_model2_Y, i32 0, i32 1), align 8
  store double 0.000000e+00, double* getelementptr inbounds (%struct.ExtY_test_model2_T* @test_model2_Y, i32 0, i32 2), align 8
  ret void
}
