...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx4 = getelementptr inbounds [100 x i32]* %buf, i32 0, i64 %idxprom3
...
for.body8:                                        ; preds = %for.cond6
  ...
  %arrayidx12 = getelementptr inbounds [100 x i32]* %buf, i32 0, i64 %idxprom11
...
if.then21:                                        ; preds = %for.body19
  ...
  %arrayidx24 = getelementptr inbounds [100 x i32]* %buf, i32 0, i64 %idxprom23
...
if.then28:                                        ; preds = %if.else
  ...
  %arrayidx31 = getelementptr inbounds [100 x i32]* %buf, i32 0, i64 %idxprom30
...
if.else34:                                        ; preds = %if.else
  ...
  %arrayidx36 = getelementptr inbounds [100 x i32]* %buf, i32 0, i64 %idxprom35
  %44 = load i32* %arrayidx36, align 4
  %45 = load i32* %j, align 4
  %idxprom37 = sext i32 %45 to i64
  %arrayidx38 = getelementptr inbounds [100 x i32]* %buf, i32 0, i64 %idxprom37
...
if.then40:                                        ; preds = %if.else34
  ...
  %arrayidx43 = getelementptr inbounds [100 x i32]* %buf, i32 0, i64 %idxprom42
...
if.else46:                                        ; preds = %if.else34
  ...
  %arrayidx49 = getelementptr inbounds [100 x i32]* %buf, i32 0, i64 %idxprom48
